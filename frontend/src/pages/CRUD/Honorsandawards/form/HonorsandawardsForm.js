...
const HonorsandawardsForm = (props) => {
  ...
  const formValidations = () => {
    return FormValidations(honorsandawardsFields, record || {});
  };

  const handleSubmit = (values) => {
    const { id, ...data } = PreparedValues(honorsandawardsFields, values || {});
    onSubmit(id, data);
  };
  ...
  const title = () => {
    ...
    return isEditing ? 'Edit Honorsandawards' : 'Add Honorsandawards';
  };
        ...
        {(form) => (
          <form onSubmit={form.handleSubmit}>
            <Grid container spacing={3} direction='column'>
              ...
              <Grid item>
                <InputFormItem
                  name={'nameofawardingorganization'}
                  schema={honorsandawardsFields}
                />
              </Grid>
              ...
              <Grid item>
                <InputFormItem
                  name={'contactsofawardingorganization'}
                  schema={honorsandawardsFields}
                />
              </Grid>
              ...
              <Grid item>
                <InputFormItem
                  name={'briefdetailsofworkhonored'}
                  schema={honorsandawardsFields}
                />
              </Grid>
