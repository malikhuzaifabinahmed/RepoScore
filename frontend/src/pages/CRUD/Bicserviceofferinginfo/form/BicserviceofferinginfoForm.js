...
const BicserviceofferinginfoForm = (props) => {
  ...
  const formValidations = () => {
    return FormValidations(bicserviceofferinginfoFields, record || {});
  };
  ...
  const title = () => {
    ...
    return isEditing
      ? 'Edit Bicserviceofferinginfo'
      : 'Add Bicserviceofferinginfo';
  };
        ...
        {(form) => (
          <form onSubmit={form.handleSubmit}>
            <Grid container spacing={3} direction='column'>
              <Grid item>
                <InputFormItem
                  name={'natureofserviceofferedsessionheld'}
