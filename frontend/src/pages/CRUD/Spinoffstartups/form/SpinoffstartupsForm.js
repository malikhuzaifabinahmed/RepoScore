...
const SpinoffstartupsForm = (props) => {
  ...
  const formValidations = () => {
    return FormValidations(spinoffstartupsFields, record || {});
  };

  const handleSubmit = (values) => {
    const { id, ...data } = PreparedValues(spinoffstartupsFields, values || {});
    onSubmit(id, data);
  };
  ...
  const title = () => {
    ...
    return isEditing ? 'Edit Spinoffstartups' : 'Add Spinoffstartups';
  };
        ...
        {(form) => (
          <form onSubmit={form.handleSubmit}>
            <Grid container spacing={3} direction='column'>
              ...
              <Grid item>
                <InputFormItem
                  name={'briefideabackingresearchsectorfield'}
                  schema={spinoffstartupsFields}
                />
              </Grid>
              ...
              <Grid item>
                <InputFormItem
                  name={'facultymembernamedesignationdepartment'}
                  schema={spinoffstartupsFields}
                />
              </Grid>
              ...
              <Grid item>
                <InputFormItem name={'stage'} schema={spinoffstartupsFields} />
              </Grid>

              <Grid item>
                <InputFormItem
                  name={'licenseagreementsignedifany'}
                  schema={spinoffstartupsFields}
                />
              </Grid>
