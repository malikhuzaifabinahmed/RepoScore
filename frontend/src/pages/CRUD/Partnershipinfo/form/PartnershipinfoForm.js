...
const PartnershipinfoForm = (props) => {
  ...
  const formValidations = () => {
    return FormValidations(partnershipinfoFields, record || {});
  };

  const handleSubmit = (values) => {
    const { id, ...data } = PreparedValues(partnershipinfoFields, values || {});
    onSubmit(id, data);
  };
  ...
  const title = () => {
    ...
    return isEditing ? 'Edit Partnershipinfo' : 'Add Partnershipinfo';
  };
        ...
        {(form) => (
          <form onSubmit={form.handleSubmit}>
            <Grid container spacing={3} direction='column'>
              <Grid item>
                <InputFormItem
                  name={'nameofpartneringorganization'}
              ...
              <Grid item>
                <InputFormItem
                  name={'majorareasofcooperationmodalities'}
                  schema={partnershipinfoFields}
                />
              </Grid>
