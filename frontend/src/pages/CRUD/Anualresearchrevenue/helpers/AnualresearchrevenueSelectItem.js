...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/anualresearchrevenue/autocomplete`, {
    params,
  });
  return response.data;
}

const AnualresearchrevenueSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.anualresearchrevenue.hasPermissionToCreate,
});

export default connect(select)(AnualresearchrevenueSelectItem);
