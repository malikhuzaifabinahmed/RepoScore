...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/humanresource/autocomplete`, { params });
  return response.data;
}

const HumanresourceSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.humanresource.hasPermissionToCreate,
});

export default connect(select)(HumanresourceSelectItem);
