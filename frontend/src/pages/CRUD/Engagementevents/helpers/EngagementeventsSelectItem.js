...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/engagementevents/autocomplete`, {
    params,
  });
  return response.data;
}

const EngagementeventsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.engagementevents.hasPermissionToCreate,
});

export default connect(select)(EngagementeventsSelectItem);
