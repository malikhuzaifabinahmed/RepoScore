...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/startupemploment/autocomplete`, {
    params,
  });
  return response.data;
}

const StartupemplomentSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.startupemploment.hasPermissionToCreate,
});

export default connect(select)(StartupemplomentSelectItem);
