...
const TrainingcourseinfoForm = (props) => {
  ...
  const formValidations = () => {
    return FormValidations(trainingcourseinfoFields, record || {});
  };

  const handleSubmit = (values) => {
    const { id, ...data } = PreparedValues(
      trainingcourseinfoFields,
      values || {},
    );
    onSubmit(id, data);
  };
  ...
  const title = () => {
    ...
    return isEditing ? 'Edit Trainingcourseinfo' : 'Add Trainingcourseinfo';
  };
        ...
        {(form) => (
          <form onSubmit={form.handleSubmit}>
            <Grid container spacing={3} direction='column'>
              ...
              <Grid item>
                <InputFormItem
                  name={'noofstartupscompletedthecourse'}
                  schema={trainingcourseinfoFields}
                />
              </Grid>
              ...
              <Grid item>
                <InputFormItem
                  name={'ifoutsourcednameofcourseoffered'}
                  schema={trainingcourseinfoFields}
                />
              </Grid>
