...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/trainingcourseinfo/autocomplete`, {
    params,
  });
  return response.data;
}

const TrainingcourseinfoSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.trainingcourseinfo.hasPermissionToCreate,
});

export default connect(select)(TrainingcourseinfoSelectItem);
