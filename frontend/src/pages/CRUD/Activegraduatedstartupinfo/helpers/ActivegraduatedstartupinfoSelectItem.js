...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/activegraduatedstartupinfo/autocomplete`, {
    params,
  });
  return response.data;
}

const ActivegraduatedstartupinfoSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.activegraduatedstartupinfo.hasPermissionToCreate,
});

export default connect(select)(ActivegraduatedstartupinfoSelectItem);
