...
const ActivegraduatedstartupinfoForm = (props) => {
  ...
  const renderForm = () => (
    <Widget title={'View activegraduatedstartupinfo'} collapse close>
            ...
            <Grid container spacing={3} direction='column'>
              <Grid item>
                <Typography variant='h6' style={{ marginBottom: 10 }}>
                  {
                    activegraduatedstartupinfoFields['nameofgraduatedstartup']
                      .label
                  }
                </Typography>
                <Typography>{form.values.nameofgraduatedstartup}</Typography>
              </Grid>

              <Grid item>
                <Typography variant='h6' style={{ marginBottom: 10 }}>
                  {activegraduatedstartupinfoFields['companybriefidea'].label}
                </Typography>
                <Typography>{form.values.companybriefidea}</Typography>
              </Grid>
              ...
              <Grid item>
                ...
                <Typography>
                  {form.values.currentstatusactiveregisteredconcernaccelerated}
                </Typography>
              </Grid>
              ...
              <Grid item>
                ...
                <Typography>
                  {form.values.networthofstartupaverageyearlyrevenue}
                </Typography>
              </Grid>
              ...
              <Grid item>
                ...
                <Typography>
                  {form.values.ipoacquisitionamalgamationifany}
                </Typography>
              </Grid>
              ...
              <Grid item>
                <Typography variant='h6' style={{ marginBottom: 10 }}>
                  {
                    activegraduatedstartupinfoFields['noofemployeeswithstartup']
                      .label
                  }
                </Typography>
                <Typography>{form.values.noofemployeeswithstartup}</Typography>
              </Grid>
              ...
              <Grid item>
                ...
                <Typography>
                  {form.values.survivalrateofgraduatedstartups}
                </Typography>
              </Grid>
              ...
              <Grid item>
                ...
                <Typography>
                  {form.values.totalstartupsactiveaftergraduation}
                </Typography>
              </Grid>
              ...
              <Grid item>
                ...
                <Typography>
                  {form.values.totalstartupshavingipoacquisition}
                </Typography>
              </Grid>

              <Grid item>
                <Typography variant='h6' style={{ marginBottom: 10 }}>
                  {activegraduatedstartupinfoFields['categoryId'].label}
                </Typography>
