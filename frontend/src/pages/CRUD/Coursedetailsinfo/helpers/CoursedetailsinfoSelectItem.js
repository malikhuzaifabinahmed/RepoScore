...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/coursedetailsinfo/autocomplete`, {
    params,
  });
  return response.data;
}

const CoursedetailsinfoSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.coursedetailsinfo.hasPermissionToCreate,
});

export default connect(select)(CoursedetailsinfoSelectItem);
