...
const StartupsappliedforpitchingForm = (props) => {
  ...
  const formValidations = () => {
    return FormValidations(startupsappliedforpitchingFields, record || {});
  };
  ...
  const title = () => {
    ...
    return isEditing
      ? 'Edit Startupsappliedforpitching'
      : 'Add Startupsappliedforpitching';
  };
        ...
        {(form) => (
          <form onSubmit={form.handleSubmit}>
            <Grid container spacing={3} direction='column'>
              ...
              <Grid item>
                <InputFormItem
                  name={'resultremarksfromcompetition'}
                  schema={startupsappliedforpitchingFields}
                />
              </Grid>
              ...
              <Grid item>
                <InputFormItem
                  name={'availabilityoffundingseedmoney'}
                  schema={startupsappliedforpitchingFields}
                />
              </Grid>
