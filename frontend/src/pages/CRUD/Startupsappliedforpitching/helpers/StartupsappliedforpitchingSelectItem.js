...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/startupsappliedforpitching/autocomplete`, {
    params,
  });
  return response.data;
}

const StartupsappliedforpitchingSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.startupsappliedforpitching.hasPermissionToCreate,
});

export default connect(select)(StartupsappliedforpitchingSelectItem);
