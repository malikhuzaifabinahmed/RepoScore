...
const StartuprevenueForm = (props) => {
  ...
  const formValidations = () => {
    return FormValidations(startuprevenueFields, record || {});
  };

  const handleSubmit = (values) => {
    const { id, ...data } = PreparedValues(startuprevenueFields, values || {});
    onSubmit(id, data);
  };
  ...
  const title = () => {
    ...
    return isEditing ? 'Edit Startuprevenue' : 'Add Startuprevenue';
  };
        ...
        {(form) => (
          <form onSubmit={form.handleSubmit}>
            <Grid container spacing={3} direction='column'>
              ...
              <Grid item>
                <InputFormItem
                  name={'incubatedsinceandexpectedgraduation'}
                  schema={startuprevenueFields}
                />
              </Grid>
              ...
              <Grid item>
                <InputFormItem
                  name={'sharingmechanismbetweenbicheiandstartup'}
                  schema={startuprevenueFields}
                />
              </Grid>
