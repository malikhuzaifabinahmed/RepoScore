...
import BicdataFormView from 'pages/CRUD/Bicdata/form/BicdataFormView';
import { push } from 'connected-react-router';
import actions from 'actions/bicdata/bicdataFormActions';
import { connect } from 'react-redux';

const BicdataFormPageView = (props) => {
...
export default connect(mapStateToProps)(BicdataFormPageView);
