...
import TrainingsFormView from 'pages/CRUD/Trainings/form/TrainingsFormView';
import { push } from 'connected-react-router';
import actions from 'actions/trainings/trainingsFormActions';
import { connect } from 'react-redux';

const TrainingsFormPageView = (props) => {
...
export default connect(mapStateToProps)(TrainingsFormPageView);
