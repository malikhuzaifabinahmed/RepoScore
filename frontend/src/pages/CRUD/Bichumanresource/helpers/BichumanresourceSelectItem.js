...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/bichumanresource/autocomplete`, {
    params,
  });
  return response.data;
}

const BichumanresourceSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.bichumanresource.hasPermissionToCreate,
});

export default connect(select)(BichumanresourceSelectItem);
