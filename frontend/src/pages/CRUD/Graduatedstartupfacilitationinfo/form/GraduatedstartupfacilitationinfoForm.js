...
const GraduatedstartupfacilitationinfoForm = (props) => {
  ...
  const title = () => {
    ...
    return isEditing
      ? 'Edit Graduatedstartupfacilitationinfo'
      : 'Add Graduatedstartupfacilitationinfo';
  };
        ...
        {(form) => (
          <form onSubmit={form.handleSubmit}>
            <Grid container spacing={3} direction='column'>
              <Grid item>
                <InputFormItem
                  name={'keyareasoffacilitationrequestedbygraduatedstartups'}
              ...
              <Grid item>
                <InputFormItem
                  name={'noofgraduatedstartupsfacilitated'}
                  schema={graduatedstartupfacilitationinfoFields}
                />
              </Grid>
              ...
              <Grid item>
                <InputFormItem
                  name={'totalstartupsincubatedsincebicsinception'}
                  schema={graduatedstartupfacilitationinfoFields}
                />
              </Grid>
              ...
              <Grid item>
                <InputFormItem
                  name={'totalstartupsgraduatedsincebicsinception'}
                  schema={graduatedstartupfacilitationinfoFields}
                />
              </Grid>
