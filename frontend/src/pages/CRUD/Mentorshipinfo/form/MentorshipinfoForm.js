...
const MentorshipinfoForm = (props) => {
  ...
  const formValidations = () => {
    return FormValidations(mentorshipinfoFields, record || {});
  };

  const handleSubmit = (values) => {
    const { id, ...data } = PreparedValues(mentorshipinfoFields, values || {});
    onSubmit(id, data);
  };
  ...
  const title = () => {
    ...
    return isEditing ? 'Edit Mentorshipinfo' : 'Add Mentorshipinfo';
  };
        ...
        {(form) => (
          <form onSubmit={form.handleSubmit}>
            <Grid container spacing={3} direction='column'>
              ...
              <Grid item>
                <InputFormItem
                  name={'mentoringsessionsheldatbicduringtheyear'}
                  schema={mentorshipinfoFields}
                />
              </Grid>
              ...
              <Grid item>
                <InputFormItem
                  name={'noofstartupsfacilitatedthroughsessions'}
                  schema={mentorshipinfoFields}
                />
              </Grid>
