...
const ColaborationagreementForm = (props) => {
  ...
  const formValidations = () => {
    return FormValidations(colaborationagreementFields, record || {});
  };

  const handleSubmit = (values) => {
    const { id, ...data } = PreparedValues(
      colaborationagreementFields,
      values || {},
    );
    onSubmit(id, data);
  };
  ...
  const title = () => {
    ...
    return isEditing
      ? 'Edit Colaborationagreement'
      : 'Add Colaborationagreement';
  };
        ...
        {(form) => (
          <form onSubmit={form.handleSubmit}>
            <Grid container spacing={3} direction='column'>
              ...
              <Grid item>
                <InputFormItem
                  name={'keyinitiativestobeundertaken'}
                  schema={colaborationagreementFields}
                />
              </Grid>
