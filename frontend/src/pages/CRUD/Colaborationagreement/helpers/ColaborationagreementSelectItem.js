...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/colaborationagreement/autocomplete`, {
    params,
  });
  return response.data;
}

const ColaborationagreementSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.colaborationagreement.hasPermissionToCreate,
});

export default connect(select)(ColaborationagreementSelectItem);
