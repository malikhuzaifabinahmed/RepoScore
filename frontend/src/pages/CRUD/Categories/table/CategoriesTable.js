...
import actionsCategories from 'actions/categories/categoriesFormActions';
...
const CategoriesTable = () => {
  ...
  const [filters, setFilters] = useState([
    { label: 'Category name', title: 'categoryname' },
    { label: 'Category type', title: 'categorytype' },
  ...
  const update = (id, data) => {
    dispatch(actionsCategories.doUpdate(id, data));
  };
  ...
  return (
    <div>
      <Widget title={humanize('Categories')} disableWidgetMenu>
        <Box className={classes.actions}>
          <Link to='/admin/categories/new' className={classes.element}>
