...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/startupsincubated/autocomplete`, {
    params,
  });
  return response.data;
}

const StartupsincubatedSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.startupsincubated.hasPermissionToCreate,
});

export default connect(select)(StartupsincubatedSelectItem);
