...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/startupincubation/autocomplete`, {
    params,
  });
  return response.data;
}

const StartupincubationSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.startupincubation.hasPermissionToCreate,
});

export default connect(select)(StartupincubationSelectItem);
