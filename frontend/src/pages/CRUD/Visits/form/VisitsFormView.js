...
const VisitsForm = (props) => {
  ...
  const renderForm = () => (
    <Widget title={'View visits'} collapse close>
            ...
            <Grid container spacing={3} direction='column'>
              <Grid item>
                <Typography variant='h6' style={{ marginBottom: 10 }}>
                  {visitsFields['nameofvisits'].label}
                </Typography>
                <Typography>{form.values.nameofvisits}</Typography>
              </Grid>

              <Grid item>
                <Typography variant='h6' style={{ marginBottom: 10 }}>
                  {visitsFields['dateofvisit'].label}
                </Typography>
                <Typography>{form.values.dateofvisit}</Typography>
              </Grid>

              <Grid item>
                <Typography variant='h6' style={{ marginBottom: 10 }}>
                  {visitsFields['agendaofvisit'].label}
                </Typography>
                <Typography>{form.values.agendaofvisit}</Typography>
              </Grid>

              <Grid item>
                <Typography variant='h6' style={{ marginBottom: 10 }}>
                  {visitsFields['categoryId'].label}
                </Typography>
