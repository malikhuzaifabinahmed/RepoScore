...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/startupmentoring/autocomplete`, {
    params,
  });
  return response.data;
}

const StartupmentoringSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.startupmentoring.hasPermissionToCreate,
});

export default connect(select)(StartupmentoringSelectItem);
